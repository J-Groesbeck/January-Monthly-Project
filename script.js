...
function change1719() {
    ...
    info.innerHTML = `<li>"Robinson Crusoe" is a novel written by Daniel Defoe, first published on April 25, 1719.</li>
                ...
                <li>It tells the story of Robinson Crusoe, a mariner who is shipwrecked and stranded on a deserted
                    island for 28 years.</li>
                <li>Crusoe's experiences on the island, including his struggle for survival, encounters with cannibals,
                    and eventual companionship with Friday, make up the core of the narrative.</li>
                <li>The novel is structured as a fictional autobiography, narrated by Robinson Crusoe himself.</li>
                <li>"Robinson Crusoe" is known for its exploration of themes such as human resilience, self-reliance,
                    and the consequences of colonialism.</li>
...
function change1917() {
    ...
    info.innerHTML = `<li>Ella Fitzgerald, a legendary jazz singer, was born on April 25, 1917, in Newport News, Virginia, USA.</li>
                    ...
                    <li>Known for her pure tone, impeccable phrasing, and scat singing, Fitzgerald became one of the most influential jazz vocalists of her time.</li>
                    <li>Over the course of her career, she collaborated with many jazz greats, including Duke Ellington, Count Basie, and Louis Armstrong.</li>
...
function change1974() {
    ...
    info.innerHTML = `<li>The overthrow of the fascist Estado Novo regime in Portugal occurred on April 25, 1974, in what is known as
                    ...
                    <li>The coup was marked by the use of red carnations, symbolizing peace, as soldiers placed these flowers in the muzzles of their guns.</li>
                    <li>The revolution was triggered by a combination of factors, including dissatisfaction with the colonial wars in Africa, economic difficulties, censorship, and restrictions on civil liberties.</li>
                    <li>The military's rebellion quickly gained popular support among civilians, leading to widespread demonstrations and celebrations across Portugal.</li>
...
function change1990() {
    ...
    info.innerHTML = `<li>The Hubble Space Telescope was launched into orbit on April 25, 1990, aboard the Space Shuttle Discovery
                    ...
                    <li>Hubble's primary mission is to observe distant galaxies, nebulae, and other celestial objects in visible, ultraviolet, and infrared light.</li>
...
function change2015() {
    ...
    info.innerHTML = `<li>A devastating earthquake with a magnitude of 7.8 struck Nepal on April 25, 2015.</li>
                    ...
                    <li>Villages and towns in rural areas were also severely affected, leading to extensive loss of life and infrastructure damage.</li>
                    <li>The earthquake triggered avalanches on Mount Everest, resulting in fatalities among climbers at the Everest Base Camp.</li>
